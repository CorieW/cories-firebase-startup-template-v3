...
3. Rename the project and package scope.

```bash
pnpm rename <new-name>
```

4. Reinstall dependencies and verify the workspace still builds.
...
5. Point the template at your Firebase project.
...
7. Fill in the required local env values.
...
8. Start local development from the repo root.
...
- Expect the dashboard dev server, `common` watch build, `back` watch build, and Firestore plus Functions emulators to start together
...
2. Configure production integrations as needed.
...
3. Customize the template for your product.
...
4. Set up repo automation if you want the included workflows.
