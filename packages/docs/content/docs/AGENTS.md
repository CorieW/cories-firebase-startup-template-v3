...
- `getting-started/`: First-run setup and docs-authoring onboarding pages.
- `guides/`: Narrative workflow and implementation guide pages.
- `reference/`: Reference pages and richer feature examples.
