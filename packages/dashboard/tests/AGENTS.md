...
- `lib/`: Unit tests for shared dashboard helpers and environment utilities.
...
- Mirror the source-area layout when adding new suites so imports and ownership stay easy to follow.
- Update this file when new top-level test groupings or cross-cutting entrypoint suites are added.
