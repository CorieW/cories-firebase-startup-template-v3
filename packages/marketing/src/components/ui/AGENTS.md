...
- `badge.tsx`: Badge primitive for small labels and section accents.
- `button.tsx`: Button primitive that supports marketing links and actions.
- `card.tsx`: Card primitives for elevated marketing content blocks.
