...
export default function MarketingStoryGrid() {
  return (
    <section
      id='story'
      className='marketing-section grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(280px,0.85fr)] lg:items-start lg:gap-12'
    >
      <SectionHeading
        ...
        support={
          <div className='grid gap-3 sm:grid-cols-2 lg:grid-cols-1'>
            <div className='rounded-[20px] border border-[color-mix(in_srgb,var(--line)_58%,transparent)] bg-[var(--surface)] px-5 py-4'>
            ...
            <div className='rounded-[20px] border border-[color-mix(in_srgb,var(--line)_58%,transparent)] bg-[color-mix(in_srgb,var(--surface-soft)_76%,var(--surface)_24%)] px-5 py-4'>
              <p className='m-0 text-xs font-semibold uppercase tracking-[0.12em] text-[var(--ink-soft)]'>
                Product surface
              </p>
              <p className='m-0 mt-2 text-sm leading-6 text-[var(--ink)]'>
                The dashboard stays dedicated to signed-in workflows and billing
                actions.
              </p>
            </div>
          </div>
        ...
        <div className='grid gap-5 md:grid-cols-2'>
          ...
          <Card className='border-[color-mix(in_srgb,var(--primary)_28%,var(--line))] bg-[var(--surface-emphasis)]'>
            ...
            <CardContent className='space-y-4'>
              <p className='m-0 text-sm leading-6 text-[var(--ink-soft)]'>
                Future projects can swap the copy and visuals without having to
                untangle dashboard logic, auth providers, or route guards.
              </p>
