...
export default function MarketingPricing() {
  return (
    <section id="pricing" className="marketing-section space-y-10">
      <SectionHeading
        ...
        support={
          <div className="space-y-3 lg:max-w-xl">
            <div className="rounded-[22px] border border-[color-mix(in_srgb,var(--line)_60%,transparent)] bg-[color-mix(in_srgb,var(--surface-soft)_78%,var(--surface)_22%)] px-6 py-5 text-sm leading-6 text-[var(--ink-soft)]">
