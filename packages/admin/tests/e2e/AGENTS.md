...
- `users.spec.ts`: User directory and detail coverage for happy-path, empty, not-found, and billing-ready states.
...
- Update this file when E2E fixtures, helpers, or suites are added, removed, renamed, or materially repurposed.
